...
var errorLoggerJs = require('@timeone-group/error-logger-js');
  ...
  get(key) {
    ...
    if (value) {
      try {
        ...
        return JSON.parse(
          pako__default['default'].inflate(compressed, {
            to: 'string',
          })
        );
      } catch (e) {
...
class StorageJS {
  ...
  save(object, { ttl } = {}) {
    if (!object.id) {
      throw new errorLoggerJs.AppError(errorLoggerJs.Severity.ERROR, 'Object must have an id property');
    }
